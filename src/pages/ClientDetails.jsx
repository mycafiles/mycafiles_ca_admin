            ...
            <div className="bg-white border-b border-[#E5E7EB] px-6 py-4 flex-shrink-0">
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        <div className={`w-12 h-12 rounded-xl flex items-center justify-center border-2 transition-colors ${isBusiness
                            ? 'bg-indigo-50 border-indigo-100/50 text-indigo-600'
                            : 'bg-emerald-50 border-emerald-100/50 text-emerald-600'
                            }`}>
                            <span className="text-xl font-black uppercase">{client.name.charAt(0)}</span>
                        </div>
                        <div>
                            <div className="flex items-center gap-2">
                                <h2 className="text-xl font-bold text-[#111827]">{client.name}</h2>
                                <Badge variant={isBusiness ? 'business' : 'individual'}>
                                    {isBusiness ? 'Business' : 'Individual'}
                                </Badge>
                            </div>
                            <div className="flex items-center gap-3 text-sm text-gray-500 mt-1">
                                <span className="font-mono bg-gray-100 px-1.5 rounded">{client.panNumber}</span>
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className="inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-200 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors bg-white shadow-sm"
                        >
                            <IconIdBadge size={16} />
                            View Details
                        </button>
                        <button
                            ...
                            className="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-900 text-sm font-medium text-white hover:bg-gray-800 transition-colors shadow-sm"
                        >
